...
helps["ado"] = _help_text("group", "Use GPT with Azure Devops Repositories.")
helps["ado review"] = _help_text("command", "Review Azure Devops PR with Open AI, and post response as a comment.")
helps["ado comment"] = _help_text("command", "Comment on Azure Devops PR with Open AI.")

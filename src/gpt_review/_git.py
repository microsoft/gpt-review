...
def _commit(gpt4: bool = False, large: bool = False, push: bool = False, _all: bool = False) -> Dict[str, str]:
    ...
    Args:
        ...
        _all (bool, optional): Whether to commit all files. Defaults to False.
